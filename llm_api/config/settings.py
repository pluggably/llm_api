...
class Settings(BaseSettings):
    ...
    session_retention_minutes: int = 1440  # 24 hours; 0 = never expire
...
def _flatten_yaml(data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    return {
        ...
        "hf_trust_remote_code": local.get("hf_trust_remote_code"),
    }
...
def get_settings() -> Settings:
    ...
    env_map = {
        ...
        "hf_trust_remote_code": "LLM_API_HF_TRUST_REMOTE_CODE",
    }
