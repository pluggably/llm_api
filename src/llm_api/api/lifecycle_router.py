...
@lifecycle_router.get("/v1/models/{model_id}/status", dependencies=[Depends(require_api_key)])
...
@lifecycle_router.post("/v1/models/{model_id}/load", dependencies=[Depends(require_api_key)])
...
@lifecycle_router.post("/v1/models/{model_id}/unload", dependencies=[Depends(require_api_key)])
